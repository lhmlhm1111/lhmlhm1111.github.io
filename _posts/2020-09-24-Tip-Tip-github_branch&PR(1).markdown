---
layout: post
title:  "[Tip] github 사용법 - 협업(Branch & PR)(1)"
subtitle:   "github 사용법 - 협업(Branch & PR)(1)"
categories: tip
tags: github git
comments: true
header-img:
...
**CONFLICT (content): Merge conflict in a.txt** 라는 경고가 뜨면서 경로 옆의 표시가 **(master|MERGING)**로 바뀐 것을 확인할 수 있습니다. `git status`를 찍으면 어떤 부분에서 문제가 발생했는지 바로 확인 가능합니다.
